...
function CommunityForum() {
  const getRelativeTime = (timeString: string) => {
    ...
    let diff = now.getTime() - postTime.getTime();
    if (diff < 0) {
            ...
            {discussions.map((discussion) => (
              ...
              >
                ...
                <TableCell className="text-right text-muted-foreground">
                  {getRelativeTime(discussion.lastPostTime)}
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
      ...
      <div className="container mx-auto px-4 md:px-6 flex flex-col items-center">
        ...
        <section className="w-full text-center py-20 md:py-32">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="mt-6 max-w-[800px] mx-auto text-muted-foreground md:text-xl">
        ...
        {/* Deformities Section */}
        <section id="deformities" className="w-full py-12 md:py-24 max-w-4xl">
        ...
        {/* Etiology Section */}
        <section id="etiology" className="w-full py-12 md:py-24 bg-card rounded-lg max-w-4xl">
        ...
        <section id="exercises" className="w-full py-12 md:py-24 bg-card rounded-lg max-w-4xl">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
        ...
        <section id="diet" className="w-full py-12 md:py-24 max-w-5xl">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
        ...
        <section id="find-doctor" className="w-full py-12 md:py-24 bg-card rounded-lg max-w-4xl">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
            ...
            <div className="max-w-md mx-auto space-y-6">
                <Card className="shadow-md transform transition-transform duration-300 hover:shadow-xl">
                  <CardHeader>
                    <CardTitle className="font-headline">
                      Kunwar Pandey
                    </CardTitle>
                  ...
                  <CardContent>
                    <Button asChild>
                      <a href="https://wa.me/8318849893" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                        <Phone />
                        WhatsApp at 8318849893
                      </a>
                    </Button>
                  </CardContent>
                </Card>
        ...
        <section id="community" className="w-full py-12 md:py-24 max-w-4xl">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <Users className="mx-auto h-12 w-12 text-primary mb-4" />
              <h2 className="text-3xl font-bold font-headline tracking-tight sm:text-4xl">
